(() => {
  ...
  const I18N = {
    en: {
      ...
      renewed: "Renewed {cn}",
      issue_title: "Create client profile",
      refresh: "Refresh",
      col_cn: "CN",
      col_status: "Status",
      col_expires: "Expires",
      ...
      form_deliver_email: "Email .ovpn after create (all enabled profiles)",
      form_deliver_telegram: "Telegram .ovpn after create (all enabled profiles)",
      form_issue: "Create",
      loading: "Loading…",
      no_clients: "No client certificates in PKI.",
      no_sessions: "No active sessions.",
      no_events: "No events yet.",
      audit_action_issue: "Create client",
    ...
    ru: {
      ...
      renewed: "Продлён {cn}",
      issue_title: "Создать клиентский профиль",
      refresh: "Обновить",
      col_cn: "CN",
      col_status: "Статус",
      ...
      audit_action_issue: "Создание клиента",
